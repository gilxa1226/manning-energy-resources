...
public class RawRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6064861137163254503L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RawRecord\",\"namespace\":\"raw.battery\",\"fields\":[{\"name\":\"uuid\",\"type\":\"string\"},{\"name\":\"arrival_time_ms\",\"type\":[\"long\",\"null\"]},{\"name\":\"body\",\"type\":[\"bytes\",\"null\"]}]}");
   ...
   */
  public static raw.battery.RawRecord.Builder newBuilder() {
    return new raw.battery.RawRecord.Builder();
  }
   ...
   * @return A new RawRecord RecordBuilder
   */
  public static raw.battery.RawRecord.Builder newBuilder(raw.battery.RawRecord.Builder other) {
    if (other == null) {
      return new raw.battery.RawRecord.Builder();
    } else {
      return new raw.battery.RawRecord.Builder(other);
    }
  }
   ...
   * @return A new RawRecord RecordBuilder
   */
  public static raw.battery.RawRecord.Builder newBuilder(raw.battery.RawRecord other) {
    if (other == null) {
      return new raw.battery.RawRecord.Builder();
    } else {
      return new raw.battery.RawRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RawRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(raw.battery.RawRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(raw.battery.RawRecord other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder setUuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder setArrivalTimeMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder clearArrivalTimeMs() {
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder setBody(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public raw.battery.RawRecord.Builder clearBody() {
      body = null;
